...
export default function Monitoring() {
    ...
    return (
        <section className="px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-15">
            <div ref={ref} className={`bg-green-900 rounded-3xl flex flex-col md:flex-row justify-between gap-6 md:gap-8 lg:gap-10 p-6 sm:p-8 md:p-12 transform transition-all duration-1000 ease-out
            ...
            `}>
                <div className="text-white font-medium space-y-4 md:w-1/2 place-content-center">
                    ...
                    <button className="text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 bg-green-400 rounded-lg cursor-pointer hover:bg-white hover:text-green-900 transition-colors">Learn More</button>
                </div>
