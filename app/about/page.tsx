  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <button className="bg-[#2E7D32] hover:bg-green-700 text-white font-medium rounded-full px-6 py-3 transition">
                MEET THE TEAM
              </button>
            </div>
      ...
      <section className="py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto px-4 mt-12">
          {[
            ...
            >
              <div className="bg-[#2E7D32] inline-flex items-center justify-center rounded-full w-16 h-16 text-white text-2xl mx-auto">
                {item.icon}
              </div>
      ...
      <section className="space-y-20 mb-20">
        <h2 className="text-3xl font-bold text-center">OUR STORES</h2>
        <div className="flex px-5 space-x-5 items-center max-w-[1000px] mx-auto">
          <div className="space-y-3">
            <h4 className="text-xl font-bold">FRESHMART ACROSS THE CITY</h4>
            <p>We&apos;re a growing supermarket chain with multiple locations throughout the city, making it convenient for you to shop for fresh groceries and household essentials.</p>
            <button className="bg-[#2E7D32] text-white text-sm font-semibold rounded-full py-3 px-5 cursor-pointer hover:bg-green-700">
              FIND NEAREST STORE
            </button>
          </div>
          <Image
          ...
          <div className="w-full sm:w-3/4 space-y-10">
            <div>
              <div className="flex justify-between items-center text-orange-400 mb-5">
                <h3 className="text-3xl font-semibold border-b-3 border-b-gray-200 w-full h-12">Home Delivery</h3>
    ...
    <section className="px-12 sm:px-25 mb-20">
      <div className="bg-gradient-to-r from-gray-300 via-gray-200 to-gray-100 w-full p-10 sm:pl-32 space-y-5 relative">
          ...
          />
          <h4 className="text-3xl font-semibold">Need Groceries Delivered?</h4>
          <p className="text-gray-500">Experience the convenience of our home delivery service. Fresh groceries delivered right to your doorstep.</p>
          <button className="border-b-2 cursor-pointer text-green-600 hover:text-green-800">Order Now</button>
        </div>
      </section>
      ...
      <section className="h-80 bg-[#1B5E20] content-center">
        <div className="flex max-w-[1000px] mx-auto items-center flex-col gap-y-10">
          ...
          <div className="grid sm:grid-cols-2 space-x-10 w-full">
            <div className="bg-white rounded space-y-3 p-8 border-b-6 border-[#2E7D32]">
              <h4 className="text-xl font-semibold">
                Quality Assurance
              </h4>
              <button className="flex items-center gap-x-2 text-[#2E7D32] text-sm font-semibold cursor-pointer hover:text-green-700">
